...
import dark from '../assets/templates/blogDark/template-blog-dark.mov';	
import phone from '../assets/iphoneX.png';
import darkphone from '../assets/templates/blogDark/template-blog-dark-mobile.mov';



class Photographe extends React.Component {
    componentDidMount() {
       ...
       <div>
           <div>
               ...
               <div class="pc-mockup">
                   ...
                   <video src={dark} className="video-template" autoPlay loop></video>
                </div>
               <div class="mobile-mockup">
                   <img src={phone} style={{width: "21%", height: "600px", display: "flex", margin: "auto"}}></img>
                   <video src={darkphone} className="video-template-phone" autoPlay loop></video>
               </div>
           </div>
           ...
           <div className="charte-graphique-two">
                <div className="charte-graphique-or">#9F8752</div>
