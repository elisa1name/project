...
import cosmetic from '../assets/templates/cosmetics/template-cosmetic.mov';	
import phone from '../assets/iphoneX.png';
import cosmetiquephone from '../assets/templates/cosmetics/template-cosmetic-mobile.mov';
       ...
       <div>
           <div>
               ...
               <div class="pc-mockup">
                   ...
                   <video src={cosmetic} className="video-template" autoPlay loop></video>
                </div>
               <div class="mobile-mockup">
                   <img src={phone} style={{width: "21%", height: "600px", display: "flex", margin: "auto"}}></img>
                   <video src={cosmetiquephone} className="video-template-phone" autoPlay loop></video>
               </div>
           </div>
           <div className="charte-graphique">
               <div className="charte-graphique-blackcosmetique">#809168</div>
               <div className="charte-graphique-grey">#6C6C6C</div>
           </div>
           <div className="charte-graphique-two">
                <div className="charte-graphique-matcha">#7E9263</div>
