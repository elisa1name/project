...
import coffeepc from '../assets/templates/coffee/template-coffee.mov';	
import phone from '../assets/iphoneX.png';
import coffeemobile from '../assets/templates/coffee/template-coffee-phone.mov';
       ...
       <div>
           <div>
               ...
               <div class="pc-mockup">
                   ...
                   <video src={coffeepc} className="video-template" autoPlay loop></video>
                </div>
               <div class="mobile-mockup">
                   <img src={phone} style={{width: "21%", height: "600px", display: "flex", margin: "auto"}}></img>
                   <video src={coffeemobile} className="video-template-phone" autoPlay loop></video>
               </div>
           </div>
           <div className="charte-graphique">
               <div className="charte-graphique-coffee">#CE9E86</div>
               <div className="charte-graphique-yellow">#FBFFAD</div>
           </div>
           <div className="charte-graphique-two">
                <div className="charte-graphique-white">#FFFFFF</div>
                <div className="charte-graphique-greendark">#245E33</div>
           </div>
       </div>
        </>
      )
