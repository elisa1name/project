...
import cook from '../assets/templates/cuisine/template-cuisine.mov';	
import phone from '../assets/iphoneX.png';
import cookphone from '../assets/templates/cuisine/template-cuisine-phone.mov';
       ...
       <div>
           <div>
               ...
               <div class="pc-mockup">
                   ...
                   <video src={cook} className="video-template" autoPlay loop></video>
                </div>
               <div class="mobile-mockup">
                   <img src={phone} style={{width: "21%", height: "600px", display: "flex", margin: "auto"}}></img>
                   <video src={cookphone} className="video-template-phone" autoPlay loop></video>
               </div>
           </div>
