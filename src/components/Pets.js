...
import Pet from '../assets/templates/animalerie/template-animalerie-two.mov';	
import phone from '../assets/iphoneX.png';
import Petsphone from '../assets/templates/animalerie/template-animalerie.mov';
       ...
       <div>
           <div>
               ...
               <div class="pc-mockup">
                   ...
                   <video src={Pet} className="video-template" autoPlay loop></video>
                </div>
               <div class="mobile-mockup">
                   <img src={phone} style={{width: "21%", height: "600px", display: "flex", margin: "auto"}}></img>
                   <video src={Petsphone} className="video-template-phone" autoPlay loop></video>
               </div>
           </div>
